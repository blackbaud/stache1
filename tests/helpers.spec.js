...
(function () {
    ...
    describe('Handlebars Helpers', function () {
        ...
        describe('isHome()', function () {
            ...
            it('should use options.hash.dest to determine if the current page is the Home Page', function () {
                var dest,
                    home;
            ...
            it('should use this.page.dest to determine if the current page is the Home Page', function () {
                var context,
                    home;
            ...
            it('should return an empty string if the current page is undefined', function () {
                var context,
                    home;
            ...
            it('should return an empty string if the current page is not the Home Page', function () {
                var dest,
                    home;
    ...
    describe('Handlebars Utilities', function () {
        ...
        describe('getNavLinks()', function () {
            ...
            it('should return an array', function () {
                ...
                navLinks = helpers.utils.getNavLinks.call({}, {
                    hash: {
            ...
            it('should return an empty array if no links are found', function () {
                ...
                result = helpers.utils.getNavLinks.call({}, {
                    hash: {}
                });
