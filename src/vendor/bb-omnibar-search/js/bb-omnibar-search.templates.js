(function (angular) {
    ...
    angular.module('OmnibarSearch.templates', [])
        .run(['$templateCache', function ($templateCache) {
            $templateCache.put("assets/bb-omnibar-search/templates/bb-omnibar-search.hbs", [
            ...
            "      <a ng-href=\"{{ result.uri }}\">{{ result.name }}</a>",
            "      <div ng-bind-html=\"result.match | limitTo: 60 | highlight:ctrl.query\"></div>",
            "    </li>",
            "  </ul>",
            "</div>"].join(''));
        }]);
