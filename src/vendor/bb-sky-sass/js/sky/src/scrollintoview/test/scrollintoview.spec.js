...
describe('Scroll into view', function () {
    ...
    describe('service', function () {
        ...
        it('should scroll a parent element if the parent is scrollable', function () {
            ...
            el = $('<div style="height: 200px"></div>');
            
            parentEl = $('<div style="height: 300px; overflow: auto"></div>')
                .append('<div style="height: 250px"></div>') // Spacer el
                .append(el);
    ...
    describe('directive', function () {
        ...
        it('should srcoll when the trigger value changes but element isn\'t immediately visible', function () {
            var $scope = $rootScope.$new(),
                animateSpy,
                el;
