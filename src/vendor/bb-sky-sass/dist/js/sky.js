...
angular.module('sky.templates', []).run(['$templateCache', function($templateCache) {
    ...
    $templateCache.put('sky/templates/actionbar/actionbaritem.html',
        '<button class="btn btn-white bb-action-bar-item-button" type="button">\n' +
        '    <ng-transclude></ng-transclude>\n' +
        '</button>\n' +
        '');
    ...
    $templateCache.put('sky/templates/grids/gridtoolbar.html',
        ...
        '        </div>\n' +
        '        <button type="button" class="btn btn-white bb-grid-toolbar-btn bb-column-picker-btn" data-bbauto-field="ColumnPickerButton" ng-show="!options.hideColPicker" ng-click="toolbarLocals.openColumnPicker()">\n' +
        '            <span class="fa fa-columns"></span>\n' +
        '            <span class="bb-toolbar-btn-label">{{resources.grid_columns_button}}</span>\n' +
        '        </button>\n' +
        '        <button type="button" class="btn btn-white bb-grid-toolbar-btn bb-filter-btn" ng-class="{\'bb-filters-inline-active\': options.filtersAreActive}" data-bbauto-field="FilterButton" ng-show="!options.hideFilters" ng-click="toolbarLocals.toggleFilterMenu()">\n' +
